        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.for-children.store') }}" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="main_image_file" type="file"
                                            id="main_image_file" required />
                                    </div>
                                </div>
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        <label for="video_file" class="form-label">Video file</label>
                                        <input id="sourceVideo" class="form-control" type="file" name="video_file" id="video_file"
                                            required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <textarea class="form-control" id="sub_content_uz" name="sub_content_uz" rows="3" required></textarea>
                            </div>

                            <div class="mb-1">
                                <label class="d-block form-label" for="sub_content_en">Sub content EN</label>
                                <textarea class="form-control" id="sub_content_en" name="sub_content_en" rows="3" required></textarea>
                            </div>
                            <div class="mb-1">
                                <label class="d-block form-label" for="sub_content_ru">Sub content Ru</label>
                                <textarea class="form-control" id="sub_content_ru" name="sub_content_ru" rows="3" required></textarea>
                            </div>
