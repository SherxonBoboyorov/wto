            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.for-children.update', ['for_child' => $forChild->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="image_file" value="{{ $forChild->image_file }}"
                                ...
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="main_image_file"
                                            value="{{ $forChild->main_image_file }}" type="file" id="main_image_file"
                                            required />
                                    </div>
                                </div>
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input id="sourceVideo" class="form-control" type="file" name="video_file"
                                            value="{{ $forChild->video_url }}" id="video_file" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $forChild->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $forChild->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $forChild->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                            ...
                            <div class="mb-1">
                                ...
                                <textarea class="form-control" id="sub_content_uz" name="sub_content_uz" value="{{ $forChild->sub_content_uz }}"
                                    rows="3" required>{{ $forChild->sub_content_uz }}</textarea>
                            </div>

                            <div class="mb-1">
                                <label class="d-block form-label" for="sub_content_en">Sub content EN</label>
                                <textarea class="form-control" id="sub_content_en" name="sub_content_en" value="{{ $forChild->sub_content_en }}"
                                    rows="3" required>{{ $forChild->sub_content_en }}</textarea>
                            </div>
                            <div class="mb-1">
                                <label class="d-block form-label" for="sub_content_ru">Sub content Ru</label>
                                <textarea class="form-control" id="sub_content_ru" name="sub_content_ru" value="{{ $forChild->sub_content_ru }}"
                                    rows="3" required>{{ $forChild->sub_content_ru }}</textarea>
                            </div>
                            <div id="editor_uz_container">
                                <div class="mb-1">
                                    <label class="d-block form-label" for="content_uz">Content Uz</label>
                                    <input type="hidden" name="content_uz" value="{{ $forChild->content_uz }}"
                            ...
                            <div id="editor_en_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_en" value="{{ $forChild->content_en }}"
                            ...
                            <div id="editor_ru_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" id="content_ru" name="content_ru"
                                        value="{{ $forChild->content_ru }}" class="form-control" placeholder="Content Ru"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" id="date_mask" name="date_mask"
                                        class="form-control flatpickr-basic" value="{{ $forChild->date_mask }}" placeholder="YYYY-MM-DD" />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $forChild->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
                            ...
                            {{-- <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select class="select2 form-select" name="category_id" id="select2-basic">
                            ...
                            <div class="d-flex mb-1 flex-column">
                                ...
                                <div class="form-check form-check-success form-switch">
                                    <input type="checkbox" @if($forChild->status==1) checked @endif name="status" value="on"
                                        class="form-check-input" id="status" />
                                </div>
                            </div>
