            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.videos.update', ['video' => $video->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="image_file" value="{{ $video->image_file }}"
                                ...
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input id="sourceVideo" class="form-control" type="file" name="video_file"
                                            value="{{ $video->video_url }}" id="video_file" required />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $video->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $video->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $video->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <select class="select2 form-select" name="gallery_id" id="select2-basic">
                                        @foreach ($gallery as $item)
                                            <option @if($item->id==$video->gallery_id) selected @endif value="{!! $item->id !!}">{{ $item->title_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    {{-- <div class="demo-inline-spacing"> --}}
                                        <div class="input-group">
                                            <input id="order" name="order" type="number" aria-label="Order"
                                                aria-describedby="order" class="touchspin" value="{{$video->order}}" />
                                        </div>
                                    {{-- </div> --}}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" id="date_mask" name="date_mask" value="{!! $video->date_mask !!}"
                                    class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" />
                            </div>
                            <div class="d-flex mb-1 flex-column">
                                <label class="form-check-label mb-50" for="status">Status</label>
                                <div class="form-check form-check-success form-switch">
                                    <input type="checkbox" @if($video->status==1) checked @endif name="status" value="on"
                                        class="form-check-input" id="status" />
                                </div>
                            </div>
