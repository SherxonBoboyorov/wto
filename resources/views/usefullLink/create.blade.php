        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.usefull-links.store') }}" enctype="multipart/form-data"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="redirect_url" name="redirect_url" class="form-control"
                                    placeholder="Redirect url" aria-label="Redirect url" aria-describedby="redirect_url" required />
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Title is required</div>
                            </div>
                            <div class="row">
                                <div class="d-flex mb-1 flex-column col-md-6">
