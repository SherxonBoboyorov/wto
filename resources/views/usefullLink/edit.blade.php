            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.usefull-links.update', ['usefull_link' => $usefullLink->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="image_file" value="{{ $usefullLink->image_file }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $usefullLink->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $usefullLink->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $usefullLink->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                            ...
                            <div class="mb-1">
                                <label class="form-label" for="title_ru">Redirect url</label>
                                <input type="text" id="redirect_url" class="form-control" name="redirect_url"
                                    value="{{ $usefullLink->redirect_url }}" placeholder="Redirect url" aria-label="Redirect url"
                                    aria-describedby="redirect_url" required />
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Title is required.</div>
                            </div>
                            ...
                            <div class="row">
                                <div class="d-flex mb-1 col-md-6 flex-column">
                                    ...
                                    <div class="form-check form-check-success form-switch">
                                        <input type="checkbox" @if($usefullLink->status==1) checked @endif name="status" value="on"
                                            class="form-check-input" id="status" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $usefullLink->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
