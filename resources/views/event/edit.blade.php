            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.event.update', ['event' => $event->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="image_file" value="{{ $event->image_file }}"
                                            type="file" id="image_file"  />
                                    </div>
                                </div>
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input id="sourceVideo" class="form-control" type="file" name="video_file"
                                            value="{{ $event->video_url }}" id="video_file" required />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $event->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $event->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $event->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                            ...
                            <div id="editor_uz_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_uz" value="{{ $event->content_uz }}"
                            ...
                            <div id="editor_en_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_en" value="{{ $event->content_en }}"
                            ...
                            <div id="editor_ru_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" id="content_ru" name="content_ru"
                                        value="{{ $event->content_ru }}" class="form-control" placeholder="Content Ru"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" id="date_mask" name="date_mask"
                                        class="form-control flatpickr-basic" value="{{ $event->date_mask }}" placeholder="YYYY-MM-DD" />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $event->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
