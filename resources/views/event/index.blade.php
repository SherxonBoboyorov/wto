    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <form id="indexFilter" action="{{ route('admin.event.index') }}">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.event.edit', ['event' => $item->id]) }}">
                                                    ...
                                                    <a type="button" onclick="setDeleteItem({{ $item->id }})"
                                                        ...
                                                        <form id="delete{{ $item->id }}"
                                                            action="{{ route('admin.event.destroy', ['event' => $item->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                ...
                {{ $events->links('vendor.pagination.vuexy-admin') }}
            </div>
        </div>
    </div>
    <!-- Bordered table end -->
