            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.activity.update', ['activity' => $activity->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="image_file" value="{{ $activity->image_file }}"
                                ...
                                {{-- <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="main_image_file"
                                            value="{{ $activity->main_image_file }}" type="file" id="main_image_file"
                                            required />
                                    </div>
                                </div> --}}
                                {{-- <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input id="sourceVideo" class="form-control" type="file" name="video_file"
                                            value="{{ $activity->video_url }}" id="video_file" required />
                                    </div>
                                </div> --}}
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    <label class="form-label" for="select2-basic">Activity Category</label>
                                    <select class="select2 form-select" name="category_id" id="select2-basic">
                                        @foreach ($category as $item)
                                            <option @if($item->id==$activity->category_id) selected @endif value="{!! $item->id !!}">{{ $item->title_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $activity->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $activity->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $activity->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                            ...
                            <div id="editor_uz_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_uz" value="{{ $activity->content_uz }}"
                            ...
                            <div id="editor_en_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_en" value="{{ $activity->content_en }}"
                            ...
                            <div id="editor_ru_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" id="content_ru" name="content_ru"
                                        value="{{ $activity->content_ru }}" class="form-control" placeholder="Content Ru"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <input type="text" id="date_mask" name="date_mask"
                                        class="form-control flatpickr-basic" value="{{ $activity->date_mask }}" placeholder="YYYY-MM-DD" />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $activity->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
                            ...
                            <div class="d-flex mb-1 flex-column">
                                ...
                                <div class="form-check form-check-success form-switch">
                                    <input type="checkbox" @if($activity->status==1) checked @endif name="status" value="on"
                                        class="form-check-input" id="status" />
                                </div>
                            </div>
