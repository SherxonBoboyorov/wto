            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.leaders.update', ['leader' => $leader->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="image_file" value="{{ $leader->image_file }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="name_uz" name="name_uz" value="{{ $leader->name_uz }}"
                                    class="form-control" placeholder="Name Uz" aria-label="Name Uz"
                                    aria-describedby="name_uz" required />
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="name_en" class="form-control" placeholder="Name En"
                                    name="name_en" value="{{ $leader->name_en }}" aria-label="Name En"
                                    aria-describedby="name_en" required />
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Name is required.</div>
                            </div>
                            <div class="mb-1">
                                ...
                                <input type="text" id="name_ru" class="form-control" name="name_ru"
                                    value="{{ $leader->name_ru }}" placeholder="Name Ru" aria-label="Name Ru"
                                    aria-describedby="name_ru" required />
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Name is required.</div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="phone" class="form-control" value="{{$leader->phone}}" placeholder="Phone"
                                ...
                                <div class="col-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="email" id="email" class="form-control" value="{{$leader->email}}" name="email"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="position_uz" name="position_uz" value="{{$leader->position_uz}}" class="form-control"
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="position_en" class="form-control"
                                            placeholder="Position En" name="position_en" value="{{$leader->position_en}}" aria-label="Position En"
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="position_ru" class="form-control" name="position_ru" value="{{$leader->position_ru}}"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="reception_days_uz" name="reception_days_uz" value="{{ $leader->reception_days_uz }}" class="form-control"
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="reception_days_en" class="form-control"
                                            placeholder="Reception days En" name="reception_days_en" value="{{ $leader->reception_days_en }}" aria-label="Reception days En"
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="reception_days_ru" class="form-control" name="reception_days_ru" value="{{ $leader->reception_days_ru }}"
                            ...
                            <div id="editor_uz_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_uz" value="{{ $leader->content_uz }}"
                            ...
                            <div id="editor_en_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" name="content_en" value="{{ $leader->content_en }}"
                            ...
                            <div id="editor_ru_container">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" id="content_ru" name="content_ru"
                                        value="{{ $leader->content_ru }}" class="form-control" placeholder="Content Ru"
                            ...
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    ...
                                    <div class="form-check form-check-success form-switch">
                                        <input type="checkbox" @if($leader->status==1) checked @endif name="status" value="on"
                                            class="form-check-input" id="status" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $leader->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
