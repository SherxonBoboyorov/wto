            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.scientific-research-category.update', ['scientific_research_category' => $scientificResearchCategory->id]) }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $scientificResearchCategory->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $scientificResearchCategory->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $scientificResearchCategory->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                            ...
                            <div class="row">
                                <div class="col-md-6 d-flex mb-1 flex-column">
                                    <label class="form-check-label mb-50" for="status">Status</label>
                                    <div class="form-check form-check-success form-switch">
                                        <input type="checkbox" @if($scientificResearchCategory->status==1) checked @endif name="status" value="on"
                                            class="form-check-input" id="status" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $scientificResearchCategory->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
