    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <form id="indexFilter" action="{{ route('admin.about.index') }}">
                                <tr id="filters" role="row">
                                    
                                    <th rowspan="1" colspan="1">
                                        <input type="text" class="form-control form-control-sm" name="id" value="{{ request('id') }}" placeholder="Id">
                                    </th>
                                    <th rowspan="1" colspan="1">
                                    </th>
                                    <th rowspan="1" colspan="1">
                                        <input type="text" class="form-control form-control-sm" name="title_uz" value="{{ request('title_uz') }}"  placeholder="Title Uz">
                                    </th>
                                    <th rowspan="1" colspan="1">
                                        <input type="text" class="form-control form-control-sm" name="title_en" value="{{ request('title_en') }}" placeholder="Title En">
                                    </th>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.about.edit', ['about' => $item->id]) }}">
                                                    ...
                                                    {{-- <a type="button" onclick="setDeleteItem({{ $item->id }})"
                                                        ...
                                                        <form id="delete{{ $item->id }}"
                                                            action="{{ route('admin.about.destroy', ['about' => $item->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                ...
                {{ $about->links('vendor.pagination.vuexy-admin') }}
            </div>
        </div>
    </div>
    <!-- Bordered table end -->
