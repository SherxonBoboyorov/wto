            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.for-children-category.update', ['for_children_category' => $forChildrenCategory->id]) }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_uz" name="title_uz" value="{{ $forChildrenCategory->title_uz }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_en" class="form-control" placeholder="Title En"
                                    name="title_en" value="{{ $forChildrenCategory->title_en }}" aria-label="Title En"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru"
                                    value="{{ $forChildrenCategory->title_ru }}" placeholder="Title Ru" aria-label="Title Ru"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input id="order" name="order" type="number" aria-label="Order"
                                            aria-describedby="order" class="touchspin" value="{{ $forChildrenCategory->order }}" />
                                    </div>
                                    {{-- </div> --}}
                                </div>
                            ...
                            <div class="d-flex mb-1 flex-column">
                                ...
                                <div class="form-check form-check-success form-switch">
                                    <input type="checkbox" @if($forChildrenCategory->status==1) checked @endif name="status" value="on"
